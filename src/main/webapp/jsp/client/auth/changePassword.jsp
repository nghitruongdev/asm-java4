          ...
          <form action="signup" method="post">
            <div class="row">
                <div class="form-floating mb-3 mt-3 col">
                  ...
                  <div class="form-floating mb-3 mt-3 col">
                    <input type="password" class="form-control" id="pswd" name="currentPassword"
                    placeholder=" " required>
            ...
            <div class="row">
                <div class="form-floating mb-3 mt-3 col">
                    <input type="password" class="form-control" id="newPswd" name="confirmPassword"
                    placeholder=" " required>
                    <label for="newPswd">New Password</label>
                  </div>
            
                  <div class="form-floating mb-3 mt-3 col">
                    <input type="password" class="form-control" id="confirm" name="newPassword"
                    placeholder=" " required>
